...
{
    public function downloadArticleExcel(){
        return Excel::download(new ArticleExport,'article_report.xlsx');
    }

    public function getData(){
        $data= Article::where("is_deleted",0)->where("is_indraft",0)
